...
public class SampleTestApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(SampleTestApp.class);

    private final Environment env;

    public SampleTestApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes SampleTest.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SampleTestApp.class);
